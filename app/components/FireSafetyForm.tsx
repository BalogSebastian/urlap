  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-8 relative font-sans text-slate-800">
        ...
        <div className="relative z-10 p-10 sm:p-14 text-center">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-900 mb-6">
            ...
            <span className="text-indigo-700">
                {activeTab === 'fire' ? "Tűzvédelmi Adatlap" : "VBS Megrendelő Adatlap"}
            </span>
          </h1>
          <p className="text-lg text-slate-500 max-w-3xl mx-auto leading-relaxed">
            {activeTab === 'fire' 
                ? "Kérjük, töltse ki a tűz- és munkavédelmi dokumentációhoz szükséges adatokat."
                : "Kérjük, adja meg a villamos biztonsági felülvizsgálathoz szükséges adatokat."}
          </p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        {activeTab === 'vbs' && (
            <>
                <Section number="01" title="Szolgáltatás kiválasztása" description="Milyen felülvizsgálatot szeretne rendelni?">
                    <div className="space-y-4 bg-yellow-50/50 p-6 rounded-2xl border border-yellow-100">
                        <CheckboxCard name="vbs_services" label="Villamos Biztonsági felülvizsgálat" />
                        <CheckboxCard name="vbs_services" label="Villámvédelmi felülvizsgálat" />
                        <CheckboxCard name="vbs_services" label="Szabványossági felülvizsgálat" />
                    </div>
                </Section>

                <Section number="02" title="Ügyfél adatai" description="A megrendelő és a helyszín adatai.">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <InputGroup label="Ügyfél Cég neve" name="companyName" placeholder="pl. Minta Kft." fullWidth required />
                        <InputGroup label="Képviseletre jogosult személy neve" name="managerName" placeholder="Vezető neve" fullWidth />
                        <InputGroup label="Képviselő telefonos elérhetősége" name="managerPhone" placeholder="+36..." fullWidth />
                        <InputGroup label="Ügyfél székhelye" name="headquarters" placeholder="Cím" required />
                    </div>
                    
                    <div className="mt-6 pt-6 border-t border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <InputGroup label="Ügyfél telephelye (ahova a szolgáltatást kéri)" name="siteAddress" placeholder="Pontos cím" required />
                        <InputGroup label="A telephely mérete (m²)" name="areaSize" type="number" placeholder="pl. 120" />
                        <InputGroup label="Az ügyfél tevékenységi köre" name="mainActivity" placeholder="pl. iroda, gyártás..." fullWidth />
                    </div>
                </Section>

                <Section number="03" title="Előzmények" description="Korábbi dokumentációk rendelkezésre állása.">
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                        <Label>Rendelkezik korábbi felülvizsgálati dokumentummal?</Label>
        ...
        {/* =========================================================================
            EREDETI TŰZVÉDELMI ADATLAP (MEGTARTVA)
           ========================================================================= */}
        {activeTab === 'fire' && (
            <>
                {/* 1. Cégadatok */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <InputGroup label="Adószám" name="taxNumber" placeholder="xxxxxxxx-x-xx" required />
                </div>
        ...
        <Section number={activeTab === 'fire' ? "11" : "04"} title="Megjegyzés" description="Bármi egyéb fontos információ.">
           <textarea 
             name="notes"
...
// --- DESIGN KOMPONENSEK (Már meglévők, csak beillesztve) ---
