          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-orange-100 focus:border-orange-500 outline-none transition-all font-bold text-slate-700"
              />
            </div>
